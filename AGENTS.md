...
| `.aspire/`, `.idea/`, `.vs/`, `.vscode/`, `.claude/`, `.omc/` | Local tooling/IDE state — not tracked in the repo |

## For AI Agents

### Working In This Directory
- `questionnaire-ui/` is a historical leftover from the deleted prototype and has no working backend — don't treat it as real feature targets without checking with the user first.
