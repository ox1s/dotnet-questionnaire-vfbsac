...
internal sealed class StudentImporter(
    IApplicationDbContext context,
    IPasswordHasher passwordHasher) : IStudentImporter
{
    public async Task<Result<int>> ImportAsync(Stream fileStream, CancellationToken cancellationToken = default)
    {
        int count = 0;
